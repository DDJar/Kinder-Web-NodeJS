export function send_Notification_Mail_Attendance_For_Child(
  firstName,
  lastName,
  title,
  context,
                      ...
                      <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                        <tbody>
                          <tr>
                            ...
                            <td class="st-Font st-Font--body " style="border: 0; margin: 0; padding: 0; color: #525F7f !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                              Kindergarten xin thông báo cho Quý Phụ Huynh rằng <h3 style="display: inline; margin: 0;font-weight: bold; ">${title}</h3>${context} ${childFirstName} ${childLastName}.</td>
                            <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                              <div class="st-Spacer st-Spacer--filler"> </div>
                            </td>
                          </tr>
                      ...
                      <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                        <tbody>
                          <tr>
                            ...
                            <td class="st-Font st-Font--body " style="border: 0; margin: 0; padding: 0; color: black !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                              <h3 style="display: inline; margin: 0; font-weight: bold;">${noteStaff}</h3>
                            </td>
                            <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                              <div class="st-Spacer st-Spacer--filler"></div>
                            </td>
                          ...
                          ${
                            linkImg
                              ? `<tr>
                            <td colspan="3" style="border: 0; margin: 0; padding: 0; text-align: center;">
                              <img style="max-width: 60%; height: auto; display: block; margin: 0 auto;" src="${linkImg}" alt="img-attendance">
                            </td>
                          </tr>`
                              : ``
                          }
                       ...
                       <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                        <tbody>
                          <tr>
                            ...
                            <td class="st-Font st-Font--body" style="border: 0; margin: 0; padding: 0; color: #525F7f !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                              Quý Phụ Huynh có thể vào phần quản lý trẻ để biết thêm thông tin.
                            </td>
                            <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                              <div class="st-Spacer st-Spacer--filler"> </div>
                            </td>
                               ...
                               <tbody>
                                 <tr>
                                   <td align="center" class="st-Button-area" height="38" valign="middle" style="border: 0; margin: 0; padding: 0; background-color: #666ee8; border-radius: 5px; text-align: center;">
                                     <a h class="st-Button-link" style="border: 0; margin: 0; padding: 0; color: #ffffff; display: block; height: 38px; text-align: center; text-decoration: none; background-color: #17a2b8;" href='${link}'>
                                       <span class="st-Button-internal" style="border: 0; margin: 0; padding: 0; color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; font-weight: bold; height: 38px; line-height: 38px; mso-line-height-rule: exactly; text-decoration: none; vertical-align: middle; white-space: nowrap; width: 100%;">     Nhấn vào<span style="border: 0; margin: 0; padding: 0; color: #666ee8; font-size: 12px; text-decoration: none;">‑</span>đây<span style="border: 0; margin: 0; padding: 0; color: #666ee8; font-size: 12px; text-decoration: none;">‑</span>để về trang web </span>
                                     </a>
                                   </td>
                                 </tr>
                               </tbody>
                      ...
                      <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                        <tbody>
                          <tr>
                            ...
                            <td class="st-Font st-Font--body" style="border: 0; margin: 0; padding: 0; color: #525F7f !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                             Nếu Quý Phụ Huynh không hài lòng với kết quả, vui lòng liên hệ ngay với văn phòng nhà trường để đảm bảo tài khoản của mình được bảo mật.                               </td>
                            <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                              <div class="st-Spacer st-Spacer--filler"> </div>
                            </td>
                          </tr>
