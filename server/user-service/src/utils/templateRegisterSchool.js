export function send_Notification_Mail_Register_School_For_Child(
  firstName,
  lastName,
  title,
  context,
                      ...
                      <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                        <tbody>
                          <tr>
                            ...
                            <td class="st-Font st-Font--body " style="border: 0; margin: 0; padding: 0; color: #525F7f !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                              Kindergarten rất vui lòng  thông báo rằng Quý Phụ Huynh <h3 style="display: inline; margin: 0;font-weight: bold; ">${title}</h3>${context} ${childFirstName} ${childLastName}.</td>
                            <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                              <div class="st-Spacer st-Spacer--filler"> </div>
                            </td>
                          </tr>
                      ...
                      <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                        <tbody>
                          <tr>
                            ...
                            <td class="st-Font st-Font--body " style="border: 0; margin: 0; padding: 0; color: red !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                          <h3 style="display: inline; margin: 0;font-weight: bold; ">${noteStaff}</h3> </td>
                            <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                              <div class="st-Spacer st-Spacer--filler"> </div>
                            </td>
                          </tr>
